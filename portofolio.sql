...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=952168095ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portofolio&table=pendiikan">`portofolio`.`pendiikan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ecommerce&table=barang">`db_ecommerce`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ecommerce&table=setting">`db_ecommerce`.`setting`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ecommerce&table=penjualan">`db_ecommerce`.`penjualan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portofolio&table=interest">`portofolio`.`interest`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portofolio&table=pengalaman">`portofolio`.`pengalaman`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portofolio&table=skill">`portofolio`.`skill`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=portofolio&table=profil">`portofolio`.`profil`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ecommerce&table=user">`db_ecommerce`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_ecommerce&table=level">`db_ecommerce`.`level`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='Baru'>Baru</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.Y2FrZQ==" data-vpath="cm9vdA==.Y2FrZQ==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=cake&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=cake' title='Struktur'>cake</a><div class="clearfloat"></div></li><li class="navGroup"><div class='block'><i></i><b></b><a class="expander loaded container" href='#'><span class="hide paths_nav" data-apath="cm9vdA==" data-vpath="cm9vdA==.ZGI=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><i><div class="block second"><u><img src="themes/dot.gif" title="Groups" alt="Groups" class="icon ic_b_group"></u></div>&nbsp;db</i><div class="clearfloat"></div><div style='display: none;' class='list_container'><ul><li class="database database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.ZGJfZWNvbW1lcmNl" data-vpath="cm9vdA==.ZGI=.ZWNvbW1lcmNl" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=db_ecommerce&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=db_ecommerce' title='Struktur'>db_ecommerce</a><div class="clearfloat"></div></li><li class="database last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.ZGJfcGVtaWxpaGFuX3dhcmdhX21pc2tpbg==" data-vpath="cm9vdA==.ZGI=.cGVtaWxpaGFuX3dhcmdhX21pc2tpbg==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=db_pemilihan_warga_miskin&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=db_pemilihan_warga_miskin' title='Struktur'>db_pemilihan_warga_miskin</a><div class="clearfloat"></div></li></ul></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-vpath="cm9vdA==.aW5mb3JtYXRpb25fc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=information_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=information_schema' title='Struktur'>information_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.bXlzcWw=" data-vpath="cm9vdA==.bXlzcWw=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=mysql&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=mysql' title='Struktur'>mysql</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVueWV3YWFuX2xhcGFuZ2Fu" data-vpath="cm9vdA==.cGVueWV3YWFuX2xhcGFuZ2Fu" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=penyewaan_lapangan&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=penyewaan_lapangan' title='Struktur'>penyewaan_lapangan</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-vpath="cm9vdA==.cGVyZm9ybWFuY2Vfc2NoZW1h" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=performance_schema&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=performance_schema' title='Struktur'>performance_schema</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGVycHVz" data-vpath="cm9vdA==.cGVycHVz" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=perpus&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=perpus' title='Struktur'>perpus</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cGhwbXlhZG1pbg==" data-vpath="cm9vdA==.cGhwbXlhZG1pbg==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=phpmyadmin&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=phpmyadmin' title='Struktur'>phpmyadmin</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cG9ydG9mb2xpbw==" data-vpath="cm9vdA==.cG9ydG9mb2xpbw==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=portofolio&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=portofolio' title='Struktur'>portofolio</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cm9sdXg=" data-vpath="cm9vdA==.cm9sdXg=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=rolux&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=rolux' title='Struktur'>rolux</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.c2lzdGVta2FzaXI=" data-vpath="cm9vdA==.c2lzdGVta2FzaXI=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=sistemkasir&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=sistemkasir' title='Struktur'>sistemkasir</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dXNlcl9kYg==" data-vpath="cm9vdA==.dXNlcl9kYg==" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=user_db&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=user_db' title='Struktur'>user_db</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.dXRzcHY=" data-vpath="cm9vdA==.dXRzcHY=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=utspv&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=utspv' title='Struktur'>utspv</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.d2FyZ2FtaXNraW4=" data-vpath="cm9vdA==.d2FyZ2FtaXNraW4=" data-pos="0"></span><img src="themes/dot.gif" title="Bentangkan/Tutup" alt="Bentangkan/Tutup" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=wargamiskin&amp;'><img src="themes/dot.gif" title="Operasi database" alt="Operasi database" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=wargamiskin' title='Struktur'>wargamiskin</a><div class="clearfloat"></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="683a2543515d7e426064462d4e454636">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="portofolio" targettable="skill">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `portofolio`.`skill` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `bahasa` VARCHAR(50) NOT NULL ,  `work_flow` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="portofolio" targettable="interest">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `portofolio`.`interest` ( `deskripsi` TEXT NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="pengalaman">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `pengalaman`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="interest">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `interest`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="pengalaman">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `interest`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="pendiikan">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `pendiikan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="pendiikan">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `pendiikan`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_ecommerce" targettable="setting">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `setting`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_ecommerce" targettable="setting">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `pendiikan` (`id`, `univ`, `fakultas`, `jurusan`, `gpa`, `periode`) VALUES (NULL, &#039;unindra&#039;, &#039;FTIK&#039;, &#039;Teknik Informatika&#039;, &#039;3.43&#039;, &#039;july 2019 - Ausgust 2024&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="portofolio" targettable="pendiikan">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `pendiikan`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_ecommerce" targettable="penjualan">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `penjualan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_ecommerce" targettable="setting">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `setting`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_ecommerce" targettable="barang">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
